    ...
    <div class="d-flex">
        <div class="dropdown d-inline-block user-dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-end">
                <!-- item-->
                <a class="dropdown-item" href="{{ route('pengguna') }}"><i class="ri-user-line align-middle me-1"></i>
                    Profile</a>
                <a class="dropdown-item d-block" href="{{ route('setting') }}"><i class="ri-settings-2-line align-middle me-1"></i>
                    Settings</a>
